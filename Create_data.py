...
# Find the indices and values of Km values transcripted poorly (negative values or 0)
...
# Only take entries with a Km value of greater than 0
...
#%%# Extract publications for all MM entries from SABIO-RK and Save as .csv ####
...
while Ltot != count:
    # Extract info for 100 entries at a time
    if Ltot-count > 100:
...
#%% Extract Authors for all MM entries in SABIO-RK
